...
/**
 * This class is responsible for processing the reports and rendering or
 * downloading the reports. It handles the request for rendering the report. The
 * method processReportDesignDocAndRenderReport writes the content in response
 * output stream.
 * 
 */
public class ReportRenderer {
	...
	private String reportDownloadFileName = "DownloadFileName";
	...
	/**
	 * This is overridden method which responsible for processing report i.e
	 * .rptdesign document.and also rendering the report. <br>
	 * It also handles downloading the report.
	 * 
	 */

	public void processReportDesignDocAndRenderReport(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			// get format in which we are going to render report
			// i.e:html,pdf,excel
			String format = request.getParameter(this.reportFormatRequestParameter);

			String downloadFileName = request.getParameter(this.reportDownloadFileName);
			...
			// first process the report using Iruntask which will create the
			// temp.rptdocument
			...
			/*
			 * This is used for pagination and setting the page number we want
			 * to display
			 */
			...
			// logger.info("Processing report completed
			// successfully:"+reportName);
	 ...
	 * @throws Exception
	 */
	public HashMap discoverAndSetParameters(IReportRunnable report, HttpServletRequest request) throws Exception {
	 ...
	 * @throws Exception
	 */
	public Object getParamValueObject(HttpServletRequest request, IScalarParameterDefn parameterObj) throws Exception {
